...
?>
    <div class="loginform">
        <div class="form-input unifr-form"><a rel="external" href="https://moodle2.unifr.ch/Shibboleth.sso/Login?entityID=https%3A%2F%2Faai.unifr.ch%2Fidp%2Fshibboleth&target=https%3A%2F%2Fmoodle2.unifr.ch%2Fauth%2Fshibboleth%2Findex.php"><img src="<?php echo $CFG->wwwroot;?>/theme/clean_unifr/pix/unifr_login.gif" class="unifr_button"></a></div>

<!--			<div class="form-label unifr-label2"><?php print_string('otherAAI','local_unifr_lang') ?></div>-->
        <div class="form-input unifr-button unifr-form"><a rel="external" href="https://moodle2.unifr.ch/auth/shibboleth/index.php"><img src="<?php echo $CFG->wwwroot;?>/theme/clean_unifr/pix/switchaai_login.gif" class="unifr_button"></a></div>
