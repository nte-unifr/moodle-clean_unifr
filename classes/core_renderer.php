 ...
 */
class theme_clean_unifr_core_renderer extends theme_bootstrapbase_core_renderer {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        $context->ext = $ext; //($context->error || (isset($_GET['ext']) && $_GET['ext'] == 1)) ? (1) : (0);
        $wayf = '';
        include_once($CFG->dirroot . '/theme/clean_unifr/wayf.php');
        $context->wayf = $wayf;
    ...
    public function standard_head_html() {
        ...
        $output .= "<link href='//fonts.googleapis.com/css?family=Open+Sans:400,700&subset=latin' rel='stylesheet' type='text/css'>";
        return $output;
    }
